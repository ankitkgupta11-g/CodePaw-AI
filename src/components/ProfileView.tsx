          ...
          <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {user.role === 'owner' ? (
                  <span
                    id="profile_owner_badge"
                    className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-800 border border-amber-300 text-[11px] font-extrabold shadow-2xs"
                  >
              ...
              <div className="text-xs text-slate-500 flex items-center gap-2 flex-wrap">
                ...
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 border border-slate-200 text-[10px] font-semibold capitalize">
                  {user.authProvider || user.provider || 'Firebase'} Auth
                </span>
              </div>
            </div>
          </div>
